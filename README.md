...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c7wmfyu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c7wmfyu.containers.anotherwebservice.com/
...
```
git clone git@github.com:IlllaP/container-c7wmfyu.git
cd container-c7wmfyu
```
...
```
docker attach container-c7wmfyu
```
